...
class ConnectorDB:
    ...
    def __init__(self,root):
        self.root = root
        titlespace = " "
        self.root.title(102 * titlespace +"Hospital Management System")
...
#================================
        ...
        def addData():
            if StudentID.get()=="" or Firstname.get()=="" or Surname.get()=="":
                ...
                sqlCon = pymysql.connect(host="localhost",user="root",password="Sonam@123",database="register")
                cur =sqlCon.cursor()
                cur.execute("insert into regdata values(%s,%s,%s,%s,%s,%s)",(StudentID.get(),Firstname.get(),Surname.get(),Address.get(),Gender.get(),Mobile.get()))
                sqlCon.commit()
                sqlCon.close()
        ...
        def DisplayData():
                sqlCon = pymysql.connect(host="localhost",user="root",password="Sonam@123",database="register")
                cur =sqlCon.cursor()
                cur.execute("select *from regdata")
                result = cur.fetchall()
                if len(result)!=0:
        ...
        def update():
                sqlCon = pymysql.connect(host="localhost",user="root",password="Sonam@123",database="register")
                cur =sqlCon.cursor()
                cur.execute("update regdata set firstname=%s,surname=%s,address=%s,gender=%s,mobile=%s where stdid=%s",(Firstname.get(),Surname.get(),Address.get(),Gender.get(),Mobile.get(),StudentID.get()))
                sqlCon.commit()
                sqlCon.close()
        ...
        def deleteDB():
                sqlCon = pymysql.connect(host="localhost",user="root",password="Sonam@123",database="register")
                cur =sqlCon.cursor()
                cur.execute("delete from regdata where stdid=%s",StudentID.get())
                sqlCon.commit()
                sqlCon.close()
        ...
        def searchDB():
            try:
                sqlCon = pymysql.connect(host="localhost",user="root",password="Sonam@123",database="register")
                cur =sqlCon.cursor()
                cur.execute("select *from regdata where stdid=%s",StudentID.get())
                row=cur.fetchall()
                StudentID.set(row[0])
                Firstname.set(row[1])
                Surname.set(row[2])
        ...
        #============
        self.lbltitle=Label(TitleFrame, font=('arial',40,'bold'),text="Hospital Management System",bd=7)
        self.lbltitle.grid(row=0,column=0,padx=132)

        self.lblStudentID=Label(LeftFrame1, font=('arial',12,'bold'),text="Patient ID",bd=7)
        ...
        self.lblFirstname=Label(LeftFrame1, font=('arial',12,'bold'),text="Patient Name",bd=7)
        ...
        self.lblSurname=Label(LeftFrame1, font=('arial',12,'bold'),text="Address",bd=7)
        ...
        self.lblAddress=Label(LeftFrame1, font=('arial',12,'bold'),text="Mobile No",bd=7)
        ...
        self.lblMobile=Label(LeftFrame1,font=('arial',12,'bold'),text="Name of Tablet",bd=5)
        ...
        self.student_records.heading("firstname",text="Patient Name")
        self.student_records.heading("surname",text="Address")
        self.student_records.heading("address",text="Mobile")
        self.student_records.heading("gender",text="Gender")
        self.student_records.heading("mobile",text="Tablet Name")
        ...
        self.btnSearch=Button(RightFrame1a,font=('arial',16,'bold'),text="Prescription",bd=4,pady=1,padx=24,width=8,height=2,command=searchDB).grid(row=4,column=0,padx=1)
